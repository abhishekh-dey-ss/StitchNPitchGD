      ...
      <div className="bg-white bg-opacity-10 backdrop-blur-xl border border-white border-opacity-20 rounded-3xl p-8 max-w-md w-full shadow-2xl">
        ...
        <div className="mb-6">
          <p className="text-white text-opacity-90 mb-4">
            This action will permanently delete all winner records. This cannot be undone.
          </p>
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <input
              ...
              className="w-full px-4 py-3 bg-white bg-opacity-10 border border-white border-opacity-20 rounded-xl text-white placeholder-white placeholder-opacity-50 focus:outline-none focus:ring-2 focus:ring-red-500 backdrop-blur-sm"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {/* Analytics and Export - Only when there are winners */}
              {winnerCount > 0 && (
                <>
                  <button
